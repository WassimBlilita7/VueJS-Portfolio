...
.btn-main {
  @apply px-6 py-3 rounded-full font-bold text-base bg-primary text-white shadow-lg hover:scale-105 hover:bg-primary-dark transition-all duration-300 transform;
}
</style> 